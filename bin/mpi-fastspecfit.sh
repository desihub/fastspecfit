...
if [ $stage = "test" ]; then
    ...
    time python /global/homes/i/ioannis/repos/desihub/fastspecfit/bin/mpi-fastspecfit --mp $mp --specprod $specprod --survey main --program dark --base-datadir /global/cfs/cdirs/desi/spectro/fastspecfit
