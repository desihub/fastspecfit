...
class TestFastspec(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.templates = os.path.join(cls.outdir, 'ftemplates-chabrier-1.2.0.fits')
        cmd = 'wget -O {} https://data.desi.lbl.gov/public/external/templates/fastspecfit/1.2.0/ftemplates-chabrier-1.2.0.fits'.format(cls.templates)
