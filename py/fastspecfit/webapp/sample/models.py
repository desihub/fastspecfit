...
class Sample(Model):
    ...
    abmag_w3 = CharField(max_length=7, default='')
    abmag_w4 = CharField(max_length=7, default='')
    ...
    abmag_err_w3 = CharField(max_length=13, default='')
    abmag_err_w4 = CharField(max_length=13, default='')
    ...
    abmag_synth_specmodel_g = CharField(max_length=6, default='')
    abmag_synth_specmodel_r = CharField(max_length=6, default='')
    abmag_synth_specmodel_z = CharField(max_length=6, default='')
    abmag_synth_photmodel_g = CharField(max_length=6, default='')
    abmag_synth_photmodel_r = CharField(max_length=6, default='')
    abmag_synth_photmodel_z = CharField(max_length=6, default='')
    abmag_synth_photmodel_w1 = CharField(max_length=6, default='')
    abmag_synth_photmodel_w2 = CharField(max_length=6, default='')
    abmag_synth_photmodel_w3 = CharField(max_length=6, default='')
    abmag_synth_photmodel_w4 = CharField(max_length=6, default='')
    ...
    siii_6312_amp = FloatField(null=True)
    siii_6312_amp_ivar = FloatField(null=True)
    siii_6312_flux = FloatField(null=True)
    siii_6312_flux_ivar = FloatField(null=True)
    siii_6312_boxflux = FloatField(null=True)
    siii_6312_vshift = FloatField(null=True)
    siii_6312_sigma = FloatField(null=True)
    siii_6312_cont = FloatField(null=True)
    siii_6312_cont_ivar = FloatField(null=True)
    siii_6312_ew = FloatField(null=True)
    siii_6312_ew_ivar = FloatField(null=True)
    siii_6312_flux_limit = FloatField(null=True)
    siii_6312_ew_limit = FloatField(null=True)
    siii_6312_chi2 = FloatField(null=True)
    ...
    siii_6312_snr = FloatField(null=True)
    ...
    siii_6312_amp_err = CharField(max_length=15, default='')
    siii_6312_flux_err = CharField(max_length=15, default='')
    siii_6312_cont_err = CharField(max_length=15, default='')
    siii_6312_ew_err = CharField(max_length=15, default='')
