...
Dust optical depth & $\tau$ (\texttt{dust2}) & 10 & 0.0, then log-spaced 0.01 to 4.0 \\
...
\caption{The seven Bayesian grid axes (\texttt{GRID\_AXIS\_COLUMNS} in
  ...
  hybrid exact-zero-plus-log-spaced design includes a point ($=0$) that
  ...
  in finer $\tau$ sampling (6 to 10 points, still
  exact-zero-plus-log-spaced --- better matching the physical clustering
  of galaxies toward low-to-moderate optical depth than uniform linear
  spacing) and metallicity (4 to 5 points), with the remainder left
  unspent for now. $U_{\rm min}$ and $\gamma$ (essentially unconstrained
