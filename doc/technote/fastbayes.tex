...
emission are included directly in the spectrum. The grid is a full
factorial design over the seven axes in Table~\ref{tab:grid}: every
combination of the seven axis values exists, so the flattened grid's
...
arithmetic, with no separate shape bookkeeping required.
...
\caption{The seven Bayesian grid axes (\texttt{GRID\_AXIS\_COLUMNS} in
  ...
  Total grid size $6\times5\times10\times1\times1\times3\times4 = 3{,}600$
