...
#   pip install --no-deps -e /global/common/software/desi/users/ioannis/fastspecfit
...
export NUMBA_CACHE_DIR=${NUMBA_CACHE_DIR:-${PSCRATCH}/fastspecfit/numba-cache/${FASTSPECFIT_VERSION}}
